...
<html>
  ...
  <script type="text/javascript">
		 ...
		 function query(){
			  ...
			  var num = $("#change_page").val();
			  var param = {
					  num:num
			  }
			  $.post("${pageContext.request.contextPath}/admin/AdminGetMerchantAll",param,function(data){
				  data = eval(data);
				  var table = "<table id='tb' class='table'> <thead><tr><th>名字</th><th>社会征信统一代码</th><th>经营范围</th><th>地址</th><th>注册资金</th><th>法人</th><th>法人电话</th><th>主管</th><th>主管电话</th><th>注册日期</th><th>营业许可证</th><th> 法人身份证</th><th>审核</th></tr></thead><tbody id='show_tbody' >";
				  var td = "";
				  for (var i = 0; i < data.length; i++) {
						td += "<td>"+data[i].merchantName+"</td><td>"+
						data[i].unifyCode+"</td><td>"+data[i].manage+"</td><td>"+
						data[i].location+"</td><td>"+data[i].money+"</td><td>"+
						data[i].corp+"</td><td>"+data[i].corpPhone+"</td><td>"+
						data[i].director+"</td><td>"+data[i].directorPhone+"</td><td>"+
						data[i].recordDate+"</td><td><img  src='${pageContext.request.contextPath }/merchantImg/"+
						data[i].licensPicture+"' width='53.3px' height='30px' "+
						"title='法人身份证图片'></td><td> "+
						"<img  src='${pageContext.request.contextPath }/merchantImg/"+
						data[i].corpPicture+"' width='53.3px' height='30px' title='法人身份证图片'>"+
						"</td><td><a href='${pageContext.request.contextPath}/admin/AdminUpdMerchantServlet?merchantId="+
						data[i].merchantId+"&adminId=${admin.adminId}&recordState="+3+"'>YES</a>"+
						"<a href='${pageContext.request.contextPath}/admin/AdminUpdMerchantServlet?merchantId="+
						data[i].merchantId+"&adminId=${admin.adminId}&recordState="+2+"'>&nbsp;&nbsp;NO</a></td></td></tr>";
						}
  ...
  <!-- JavaScript files-->
    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <!-- 主体部分 -->
        <div class="content-inner" style="overflow-x:auto;" width="800px" height="500px">
			<!-- 这是自己写功能模块 -->
			<div class="box">
			<br>
    <div class="title" style="color:gold;margin:0 0 auto;"><b>商家审核</b></div>
    <div class="content">
        <!--搜索输入框及查询、重置按钮-->
            ...
            <div class="person_search">
                <div class="search_input">
                    <div class="input-group mb-3">
                        ...
                        <input id="Ktext" type="text" class="form-control" placeholder="请输入商家ID">
                    </div>
                </div>
                <div class="search_input">
