...
<html>
  ...
  <script type="text/javascript">
		 ...
		 function query(){
			  ...
			  var x = $("#change_page").val();
			  var param = {
					  x:x
			  }
			  $.post("${pageContext.request.contextPath}/admin/AdminCommodityVServlet",param,function(data){
				  data = eval(data);
				  var table = "<table id='tb' border='1'  class='table'> <thead><tr><th>名字</th><th>描述</th><th>单价</th><th>VIP单价</th><th>详细类型名字</th><th>详细类型描述</th><th>类型名字</th><th>类型描述</th><th>商家名字</th><th>审核信息</th></tr></thead><tbody id='show_tbody' >";
				  var td = "";
				  console.log(data);
				  for (var i = 0; i < data.length; i++) {
					td += "<tr><td>"+data[i].commodityName+"</td><td>"+data[i].commodityDescribe+"</td><td>"+data[i].price+"</td><td>"+data[i].vipPrice+"</td><td>"+data[i].subtypeName+
					"</td><td>"+data[i].subtypeDescribe+"</td><td>"+data[i].typeName+"</td><td>"+data[i].typeDescribe+"</td><td>"+data[i].merchantName+
					"</td><td><a href='${pageContext.request.contextPath}/admin/AdminUpdCommodityServlet?commodityId="+data[i].commodityId+
					"&adminId=${admin.adminId}&checkInfo="+3+"'>YES&nbsp;</a><a href='${pageContext.request.contextPath}/admin/AdminUpdCommodityServlet?commodityId="+data[i].commodityId+
					"&adminId=${admin.adminId}&checkInfo="+2+"'>NO</a></td></tr>";
					}
    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner" style="overflow-x:auto;" width="800px" height="500px">
			...
			<div class="box">
			<br>
    <div class="title" style="color:gold;margin:0 0 auto;"><b>商品审核</b></div>
    <div class="content">
        <!--搜索输入框及查询、重置按钮-->
            ...
            <div class="person_search">
                <div class="search_input">
                    <div class="input-group mb-3">
                        ...
                        <input id="Ktext" type="text" class="form-control" placeholder="请输入商品ID">
                    </div>
                </div>
                <div class="search_input">
