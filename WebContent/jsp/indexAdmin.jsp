...
<html>
  ...
  <!-- JavaScript files-->
    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
          ...
          <!-- Page Header-->
           <div class="welcome">
              		<div class="container">
							<h1 class="effect1">您好，欢迎登陆“南老板”后台管理系统！</h1>
						</div>
     ...
     <script src="${pageContext.request.contextPath }/js/welcomeanime.min.js"></script>
     <script src="${pageContext.request.contextPath }/js/welcomescript.js"></script>
  </body>
</html>