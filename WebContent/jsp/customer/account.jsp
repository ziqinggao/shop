					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a  id="login.html">Login</a></li> 
								<li><a href="${pageContext.request.contextPath}/customer/LoginOutServlet">Sign Up</a></li>
							</ul>
						</div>                  
					</div>	
				</li>
		...
		<div class="w3_login">
			...
			<div class="w3_login_module">
				<div class="module form-module">
				  <div class="toggle" onclick="window.location.href='${pageContext.request.contextPath}/jsp/customer/registered.jsp'"><i class="fa fa-times fa-pencil"></i>
					<div class="tooltip" style="right:-40px;">注册</div>
				  </div>
				  <div class="form">
					<h2>请输入您的账户信息</h2>
					<form action="#" method="post">
