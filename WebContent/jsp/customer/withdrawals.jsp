		...
		<form action="" class="am-form" id="doc-vld-msg">
			<div class="tr_rechbox">
				<div class="tr_rechhead">
					...
					<p>提现帐号：<span>${sessionScope.account.phone}</span>
				...
				<div class="tr_rechoth am-form-group">
					<span>其他金额：</span>
					<input type="number" min="1" max="1000000" value="1.00元" class="othbox" data-validation-message="充值金额范围：1-100000元" />
					<!--<p>充值金额范围：10-10000元</p>-->
				</div>
				<div class="tr_rechcho am-form-group">
					<span>提现方式：</span>
					<label class="am-radio">
							<input class="radio1" type="radio" name="radio1" value="" data-am-ucheck required data-validation-message="请选择一种提现方式"><img src="${pageContext.request.contextPath }/imgs/wechatpay.png">
						</label>
					<label class="am-radio" style="margin-right:30px;">
							<input class="radio2" type="radio" name="radio1" value="" data-am-ucheck data-validation-message="请选择一种提现方式"><img src="${pageContext.request.contextPath }/imgs/zfbpay.png">
						</label>
				</div>
			...
			<div class="tr_paybox">
				<input type="button"  id="monney" value="确认提现" class="tr_pay am-btn" />
			</div>
		</form>
	</div>
</div>
