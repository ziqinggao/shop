      ...
      $(function(){
    	...
    	// 将所有.ui-choose实例化
    	  ...
    	  $("#monney").click(function(){
    		  ...
    		  var price=${sessionScope.account.balance};
    		  var a=new RegExp("元");
    		  ...
    		  $.post("${pageContext.request.contextPath }/customer/WithDrawalsAccountBalanceServlet",param,function(data){
		...
		<form action="" class="am-form" id="doc-vld-msg">
			<div class="tr_rechbox">
				<div class="tr_rechhead">
					...
					<p>转账帐号：469026199703064589
						<% %>
					</p>
					<div class="tr_rechheadcion">
						<img src="${pageContext.request.contextPath }/imgs/coin.png" alt="" />
						<span >当前余额：<span  ><span style="margin-left:6px">${sessionScope.account.balance}</span></span></span>
					</div>
				</div>
					...
					<ul class="ui-choose am-form-group" id="uc_01">
						<li>
							<label class="am-radio-inline">
									...
									<input type="radio"  value="" name="docVlGender" required data-validation-message="请选择一项转账额度"> </br><P>100￥</P></label>
						</li>
						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项转账额度"></br><P>200￥</P>
								</label>
						</li>

						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项转账额度"> </br><P>500￥</P>
								</label>
						</li>
						<li>
							<label class="am-radio-inline">
									<input type="radio" name="docVlGender" data-validation-message="请选择一项转账额度"> </br><P>其它金额</P>
								</label>
						</li>
					</ul>
				...
				<div class="tr_rechoth am-form-group">
					<span>其他金额：</span>
					<input type="number" min="1" max="1000000" value="1.00元" class="othbox" data-validation-message="转账金额范围：1-100000元" />
					<!--<p>充值金额范围：10-10000元</p>-->
				</div>
				<div class="tr_rechcho am-form-group">
					<span>转账方式：</span>
					<label class="am-radio">
							<input class="radio1" type="radio" name="radio1" value="" data-am-ucheck required data-validation-message="请选择一种转账方式"><img src="${pageContext.request.contextPath }/imgs/wechatpay.png">
						</label>
					<label class="am-radio" style="margin-right:30px;">
							<input class="radio2" type="radio" name="radio1" value="" data-am-ucheck data-validation-message="请选择一种转账方式"><img src="${pageContext.request.contextPath }/imgs/zfbpay.png">
						</label>
				</div>
				<div class="tr_rechnum">
					<span>转账金额：</span>
					<p class="rechnum" id="balance">0.00</p>
				</div>
			</div>
			<div class="tr_paybox">
				<input type="button"  id="monney" value="确认转账" class="tr_pay am-btn" />
			</div>
		</form>
	</div>
</div>
