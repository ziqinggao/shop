...
public class OrderParticulars {
	...
	public OrderParticulars(int particularsId, int orderId, int commodityId, String subsort, int commodityNumber,
			double commodityPrice, double commodityPrices, String buyDate, int state, String sendDate,
			String returnDate) {
		super();
