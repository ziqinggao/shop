...
public class RepertoryV {
	...
	public RepertoryV(int repertoryId, int commodityId, int merchantId, String commodityName, String subsort,
			int checkRepertory, int countRepertory, String checkDate, String checkName) {
		super();
		this.repertoryId = repertoryId;
		this.commodityId = commodityId;
		this.merchantId = merchantId;
