...
/**
 * Servlet implementation class doInsCommoditySubsortServlet
 */
@WebServlet("/commodity/doInsCommoditySubsortServlet")
public class doInsCommoditySubsortServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CommoditySubsort commoditySubsort=new CommoditySubsort(0,sortId,subsortName,price,vipprice,state,1);
		boolean falg=service.doInsCommoditySubsort(commoditySubsort);
		out.print(falg);
	}
