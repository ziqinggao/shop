...
@WebServlet("/commodity/getCommoditySubtypeServlet")
public class getCommoditySubtypeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<CommoditySubtype> list=service.getSubtypeAll();
