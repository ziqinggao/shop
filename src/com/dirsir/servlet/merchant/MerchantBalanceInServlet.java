...
@WebServlet("/merchant/MerchantBalanceInServlet")
public class MerchantBalanceInServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean flag = service.merchantBalanceIn(account, merchantBalance);
