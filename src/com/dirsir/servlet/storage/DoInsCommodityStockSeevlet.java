...
/**
 * Servlet implementation class DoInsCommodityStockSeevlet
 */
@WebServlet("/storage/DoInsCommodityStockServlet")
public class DoInsCommodityStockSeevlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		CommodityStock commoditystock = new CommodityStock(0, merchantId, commodityid, subname, stockNumber, price,
				prices, procurement, null, supplier);
		boolean flag = service.commodityAdd(commoditystock);
		out.print(flag);
	}
