...
/**
 * Servlet implementation class UpdateAccountBlance
 */
@WebServlet("/customer/UpdateAccountBlance")
public class UpdateAccountBlance extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*int tardingId, int accountId, String tradingDate, double tardingPrices, int tardingType,
			String note*/
		AccountTarding accounttarding =new AccountTarding(1,accountid,null,tardingPrices,2,"≥‰÷µ");
